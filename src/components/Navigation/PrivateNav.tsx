  ...
  return (
    <header className="relative flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-sm py-3 dark:bg-neutral-800">
      <nav className="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between">
        ...
        >
          <div className="flex flex-col m-2 gap-5 sm:flex-row sm:items-center sm:justify-end sm:ps-5 text-black">
            <a
            ...
            <a
              className="text-sm font-medium leading-none hover:text-gray-400 focus:outline-hidden focus:text-gray-400 dark:text-neutral-400 dark:hover:text-neutral-500 dark:focus:text-neutral-500"
              href="#"
            >
              Work
            </a>
